    ...
    <div className="!text-slate-950 dark:!text-white font-Poppins">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto text-justify">
        <p className="min-[240px]:text-sm sm:text-base xl:text-lg">
          ...
          come with learning and growing in the programming industry. That's why
          I created Course Cosmos - to provide new programmers with the
          ...
          <br />
          <br />
          But Course Cosmos is more than just a community - we're a family. Our
          ...
          <br />
          <br />
          With Course Cosmos by your side, there's nothing standing between you
